...
public:
  ...
  void Insert(LinearContainer<Data>&&) noexcept; // Move of the value; From LinearContainer
  void Remove(const LinearContainer<Data>&) noexcept; // From LinearContainer
...
public:
  ...
  virtual void Map(const MapFunctor, void*) override ; // Override MappableContainer member
