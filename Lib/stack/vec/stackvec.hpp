...
protected:
  ...
  // It can also be seen as the top of the stack
  ulong sizeofstack = 0 ;
...
public:
  ...
  inline bool Empty() const noexcept override {return (sizeofstack==0);} // Override Container member

  inline ulong Size() const noexcept override {return sizeofstack;} // Override Container member
